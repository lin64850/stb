        ...
        if (url) {
            ...
            new SetTimeout(300).enable(() => {
                ...
                window.location.href = new FormatUrl(url, {
                    ...params,
                    return: new FormatUrl("./search.html", { /** 参数设置 */ }).getEncodeURIComponent()
...
PageRegister(Page, {
    ...
    source: new PageSource(`${Config.mainCookieName}_search_source`),
    cokStatus: new Cookie(`${Config.mainCookieName}_search_status`)
});