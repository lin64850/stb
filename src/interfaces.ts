...
interface IAuthentication {
     ...
     * @param token token
     * @param business 业务号
     * @param backUrl 鉴权回调地址，可以带参数，参数会传给回调地址；如果是 APK backUrl 可以为空
     ...
     */
    (videoId: string, episode: number, token: string, business: string, backUrl: string): Promise<AuthenticationResult>;
}
